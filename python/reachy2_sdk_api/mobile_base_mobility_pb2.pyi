...
class TargetDirectionCommand(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["direction", b"direction", "id", b"id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["direction", b"direction", "id", b"id"]) -> None: ...
...
class SetSpeedVector(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["duration", b"duration", "id", b"id", "rot_vel", b"rot_vel", "x_vel", b"x_vel", "y_vel", b"y_vel"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["duration", b"duration", "id", b"id", "rot_vel", b"rot_vel", "x_vel", b"x_vel", "y_vel", b"y_vel"]) -> None: ...
