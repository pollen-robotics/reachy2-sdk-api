...
class DirectionVector(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["vtheta", b"vtheta", "vx", b"vx", "vy", b"vy"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["vtheta", b"vtheta", "vx", b"vx", "vy", b"vy"]) -> None: ...
