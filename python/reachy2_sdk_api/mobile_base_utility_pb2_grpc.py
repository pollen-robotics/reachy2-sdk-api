...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in mobile_base_utility_pb2_grpc.py depends on'
...
def add_MobileBaseUtilityServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('reachy.part.mobile.base.utility.MobileBaseUtilityService', rpc_method_handlers)
