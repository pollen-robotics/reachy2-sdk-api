...
class CameraFeatures(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["depth", b"depth", "name", b"name", "stereo", b"stereo"]) -> None: ...
...
class CameraParameters(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["D", b"D", "K", b"K", "P", b"P", "R", b"R", "distortion_model", b"distortion_model", "height", b"height", "width", b"width"]) -> None: ...
...
class ListOfCameraFeatures(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["camera_feat", b"camera_feat"]) -> None: ...
...
class FrameRaw(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["timestamp", b"timestamp"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["data", b"data", "encoding", b"encoding", "height", b"height", "isbigendian", b"isbigendian", "step", b"step", "timestamp", b"timestamp", "width", b"width"]) -> None: ...
...
class ViewRequest(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["_view", b"_view", "camera_feat", b"camera_feat", "view", b"view"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["_view", b"_view", "camera_feat", b"camera_feat", "view", b"view"]) -> None: ...
