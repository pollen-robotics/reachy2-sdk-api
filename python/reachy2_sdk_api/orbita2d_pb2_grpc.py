...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in orbita2d_pb2_grpc.py depends on'
...
def add_Orbita2dServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('component.orbita2d.Orbita2dService', rpc_method_handlers)
