...
if _version_not_supported:
    raise RuntimeError(
        ...
        + f' but the generated code in dynamixel_motor_pb2_grpc.py depends on'
...
def add_DynamixelMotorServiceServicer_to_server(servicer, server):
    ...
    server.add_registered_method_handlers('component.dynamixel_motor.DynamixelMotorService', rpc_method_handlers)
