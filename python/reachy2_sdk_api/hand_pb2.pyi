...
class Hand(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["info", b"info", "part_id", b"part_id", "type", b"type"]) -> None: ...
...
class ParallelGripperPosition(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["gripper_position", b"gripper_position", "opening_percentage", b"opening_percentage", "position", b"position"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["gripper_position", b"gripper_position", "opening_percentage", b"opening_percentage", "position", b"position"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["gripper_position", b"gripper_position"]) -> typing.Literal["opening_percentage", "position"] | None: ...
...
class HandJointGoal(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["duration", b"duration", "goal_request", b"goal_request"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["duration", b"duration", "goal_request", b"goal_request"]) -> None: ...
