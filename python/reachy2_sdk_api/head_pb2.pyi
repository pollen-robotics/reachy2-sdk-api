...
class AntennaJointGoal(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["antenna", b"antenna", "duration", b"duration", "id", b"id", "joint_goal", b"joint_goal"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["antenna", b"antenna", "duration", b"duration", "id", b"id", "joint_goal", b"joint_goal"]) -> None: ...
...
class HeadComponentsCommands(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["l_antenna_command", b"l_antenna_command", "neck_command", b"neck_command", "r_antenna_command", b"r_antenna_command"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["l_antenna_command", b"l_antenna_command", "neck_command", b"neck_command", "r_antenna_command", b"r_antenna_command"]) -> None: ...
