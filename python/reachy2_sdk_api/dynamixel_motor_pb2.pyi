...
class DynamixelMotorGoal(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["duration", b"duration", "goal_position", b"goal_position", "id", b"id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["duration", b"duration", "goal_position", b"goal_position", "id", b"id"]) -> None: ...
...
class DynamixelMotorCommand(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["compliant", b"compliant", "goal_position", b"goal_position", "id", b"id", "speed_limit", b"speed_limit", "torque_limit", b"torque_limit"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["compliant", b"compliant", "goal_position", b"goal_position", "id", b"id", "speed_limit", b"speed_limit", "torque_limit", b"torque_limit"]) -> None: ...
