...
class Rotation3d(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["matrix", b"matrix", "q", b"q", "rotation", b"rotation", "rpy", b"rpy"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["matrix", b"matrix", "q", b"q", "rotation", b"rotation", "rpy", b"rpy"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["rotation", b"rotation"]) -> typing.Literal["q", "rpy", "matrix"] | None: ...
...
class PointDistanceTolerances(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["x_tol", b"x_tol", "y_tol", b"y_tol", "z_tol", b"z_tol"]) -> None: ...
...
class ExtEulerAnglesTolerances(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["pitch_tol", b"pitch_tol", "roll_tol", b"roll_tol", "yaw_tol", b"yaw_tol"]) -> None: ...
