...
class PID3d(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["motor_1", b"motor_1", "motor_2", b"motor_2", "motor_3", b"motor_3"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["motor_1", b"motor_1", "motor_2", b"motor_2", "motor_3", b"motor_3"]) -> None: ...
...
class Limits3d(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["pitch", b"pitch", "roll", b"roll", "yaw", b"yaw"]) -> builtins.bool: ...
...
class Orbita3dGoal(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["duration", b"duration", "id", b"id", "rotation", b"rotation"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["duration", b"duration", "id", b"id", "rotation", b"rotation"]) -> None: ...
...
class Orbita3d(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["id", b"id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["id", b"id", "serial_number", b"serial_number"]) -> None: ...
