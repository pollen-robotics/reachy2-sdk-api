...
<<<<<<< HEAD
    ...
    def ClearField(self, field_name: typing.Literal["activated", b"activated", "elbow_state", b"elbow_state", "id", b"id", "shoulder_state", b"shoulder_state", "timestamp", b"timestamp", "wrist_state", b"wrist_state"]) -> None: ...
...
<<<<<<< HEAD
    def HasField(self, field_name: typing.Literal["duration", b"duration", "goal_pose", b"goal_pose", "id", b"id", "orientation_tolerance", b"orientation_tolerance", "position_tolerance", b"position_tolerance", "q0", b"q0"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["duration", b"duration", "goal_pose", b"goal_pose", "id", b"id", "orientation_tolerance", b"orientation_tolerance", "position_tolerance", b"position_tolerance", "q0", b"q0"]) -> None: ...
=======
