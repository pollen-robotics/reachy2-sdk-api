...
class ArmState(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["elbow_state", b"elbow_state", "id", b"id", "shoulder_state", b"shoulder_state", "timestamp", b"timestamp", "wrist_state", b"wrist_state"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["activated", b"activated", "elbow_state", b"elbow_state", "id", b"id", "reachability", b"reachability", "shoulder_state", b"shoulder_state", "timestamp", b"timestamp", "wrist_state", b"wrist_state"]) -> None: ...
...
class ReachabilityAnswer(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["is_reachable", b"is_reachable", "order_id", b"order_id"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["description", b"description", "is_reachable", b"is_reachable", "order_id", b"order_id"]) -> None: ...
...
class ArmDescription(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["elbow", b"elbow", "shoulder", b"shoulder", "wrist", b"wrist"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["elbow", b"elbow", "shoulder", b"shoulder", "wrist", b"wrist"]) -> None: ...
...
class ListOfArm(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["arm", b"arm"]) -> None: ...
...
class ArmPosition(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["elbow_position", b"elbow_position", "shoulder_position", b"shoulder_position", "wrist_position", b"wrist_position"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["elbow_position", b"elbow_position", "shoulder_position", b"shoulder_position", "wrist_position", b"wrist_position"]) -> None: ...
...
class ArmCartesianGoal(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["d_theta_max", b"d_theta_max", "duration", b"duration", "goal_pose", b"goal_pose", "id", b"id", "order_id", b"order_id", "orientation_tolerance", b"orientation_tolerance", "position_tolerance", b"position_tolerance", "preferred_theta", b"preferred_theta", "q0", b"q0"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["constrained_mode", b"constrained_mode", "continuous_mode", b"continuous_mode", "d_theta_max", b"d_theta_max", "duration", b"duration", "goal_pose", b"goal_pose", "id", b"id", "order_id", b"order_id", "orientation_tolerance", b"orientation_tolerance", "position_tolerance", b"position_tolerance", "preferred_theta", b"preferred_theta", "q0", b"q0"]) -> None: ...
...
class ArmFKSolution(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["end_effector", b"end_effector"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["end_effector", b"end_effector", "success", b"success"]) -> None: ...
...
class ArmIKSolution(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["arm_position", b"arm_position", "error", b"error"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["arm_position", b"arm_position", "error", b"error", "success", b"success"]) -> None: ...
...
class ArmStatus(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["elbow_status", b"elbow_status", "shoulder_status", b"shoulder_status", "wrist_status", b"wrist_status"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["elbow_status", b"elbow_status", "shoulder_status", b"shoulder_status", "wrist_status", b"wrist_status"]) -> None: ...
...
class ArmLimits(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["elbow_limits", b"elbow_limits", "shoulder_limits", b"shoulder_limits", "wrist_limits", b"wrist_limits"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["elbow_limits", b"elbow_limits", "shoulder_limits", b"shoulder_limits", "wrist_limits", b"wrist_limits"]) -> None: ...
...
class ArmTemperatures(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["elbow_temperature", b"elbow_temperature", "shoulder_temperature", b"shoulder_temperature", "wrist_temperature", b"wrist_temperature"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["elbow_temperature", b"elbow_temperature", "shoulder_temperature", b"shoulder_temperature", "wrist_temperature", b"wrist_temperature"]) -> None: ...
...
class ArmComponentsCommands(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["elbow_command", b"elbow_command", "shoulder_command", b"shoulder_command", "wrist_command", b"wrist_command"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["elbow_command", b"elbow_command", "shoulder_command", b"shoulder_command", "wrist_command", b"wrist_command"]) -> None: ...
