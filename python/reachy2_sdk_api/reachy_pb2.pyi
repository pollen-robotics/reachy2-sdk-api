...
class Reachy(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["head", b"head", "id", b"id", "info", b"info", "l_arm", b"l_arm", "l_hand", b"l_hand", "mobile_base", b"mobile_base", "r_arm", b"r_arm", "r_hand", b"r_hand", "tripod", b"tripod"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["head", b"head", "id", b"id", "info", b"info", "l_arm", b"l_arm", "l_hand", b"l_hand", "mobile_base", b"mobile_base", "r_arm", b"r_arm", "r_hand", b"r_hand", "tripod", b"tripod"]) -> None: ...
...
class ReachyInfo(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["api_version", b"api_version", "core_mode", b"core_mode", "serial_number", b"serial_number", "version_hard", b"version_hard", "version_soft", b"version_soft"]) -> None: ...
...
class ReachyState(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["head_state", b"head_state", "id", b"id", "l_arm_state", b"l_arm_state", "l_hand_state", b"l_hand_state", "mobile_base_state", b"mobile_base_state", "r_arm_state", b"r_arm_state", "r_hand_state", b"r_hand_state", "timestamp", b"timestamp", "tripod_state", b"tripod_state"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["head_state", b"head_state", "id", b"id", "l_arm_state", b"l_arm_state", "l_hand_state", b"l_hand_state", "mobile_base_state", b"mobile_base_state", "r_arm_state", b"r_arm_state", "r_hand_state", b"r_hand_state", "timestamp", b"timestamp", "tripod_state", b"tripod_state"]) -> None: ...
...
class ReachyStatus(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["head_status", b"head_status", "id", b"id", "l_arm_status", b"l_arm_status", "l_hand_status", b"l_hand_status", "mobile_base_status", b"mobile_base_status", "r_arm_status", b"r_arm_status", "r_hand_status", b"r_hand_status", "timestamp", b"timestamp", "tripod_status", b"tripod_status"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["head_status", b"head_status", "id", b"id", "l_arm_status", b"l_arm_status", "l_hand_status", b"l_hand_status", "mobile_base_status", b"mobile_base_status", "r_arm_status", b"r_arm_status", "r_hand_status", b"r_hand_status", "timestamp", b"timestamp", "tripod_status", b"tripod_status"]) -> None: ...
...
class ReachyComponentsCommands(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["head_commands", b"head_commands", "l_arm_commands", b"l_arm_commands", "l_hand_commands", b"l_hand_commands", "r_arm_commands", b"r_arm_commands", "r_hand_commands", b"r_hand_commands"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["head_commands", b"head_commands", "l_arm_commands", b"l_arm_commands", "l_hand_commands", b"l_hand_commands", "r_arm_commands", b"r_arm_commands", "r_hand_commands", b"r_hand_commands"]) -> None: ...
